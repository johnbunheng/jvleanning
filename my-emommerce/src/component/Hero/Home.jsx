    ...
    return ( 
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                ...
                <p class="mb-8 text-lg font-khmer font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">អ្វីដែលខ្ញុំរៀន និងអ្វីដែលខ្ញុំអនុវត្ត គឺជាការចែករំលែកចំណេះដឹង ទ្រឹស្តី ការសិក្សាស្រាវជ្រាវ បទពិសោធន៍អនុវត្តនជាក់ស្តែង និងឧត្តមានុវត្តដែលវាគ្មិនបានពិភាក្សា ព្រមទាំងអ្នកចូលរួមទាំងអស់បានចែករំលែក ក្នុងបំណងជួយពង្រឹងការអភិវឌ្ឍ និងការអនុវត្តរបៀបវារៈនានា</p>
                ...
                <div class="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
                    ...
                    <div class="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-10 justify-center items-center mt-8 text-gray-500 sm:justify-between ">
                         {
                            cuorse.map((item)=>{
                                return(
                                    
                                   <div class="max-w-sm p-5 bg-white border justify-items-center border-gray-200 rounded-lg shadow-sm hover:scale-110 duration-200 dark:bg-gray-800 dark:border-gray-700">
                                        <a href="#">
                                        ...
                                        <div class="p-5">
                                            ...
                                            <Link to={item.link} href="#" class="inline-flex items-center px-3 py-2 text-sm font-khmer font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                ចាប់ផ្តើមរៀន
